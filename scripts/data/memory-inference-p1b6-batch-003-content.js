...
module.exports = [
  ...
  // --- p1b6-sk-135ab77919a554dc | HELD/ESCALATE | per-occurrence vs aggregated total ---
  {
    ...
    turns: [
      ['USER', '이번 출장에서 taxi를 세 번 탔어. 정산 sheet에는 건별 금액 칸이랑 합계 칸이 나란히 있고.'],
      ['USER', '호텔 조식은 생각보다 괜찮았어.'],
      ['USER', '더 정확히 말하면 내가 적어 낸 숫자는 rough하게 3만 원 안팎이야.'],
    ],
    ev: [0, 2], anchor: [2, 'rough하게 3만 원 안팎'],
  },
  {
    sk: 'p1b6-sk-135ab77919a554dc', lang: 'KO', dp: 'RETURN_TO_TOPIC',
    turns: [
      ['USER', '아까 얘기하던 워크숍 인쇄물 말인데, 세 세션에 나눠서 돌렸어.'],
      ['USER', '프린터 용지는 어제 새로 채워 놨어.'],
      ['USER', '다시 인쇄물 얘기로 오면, 신청서에 세션별 장수 칸이랑 총 장수 칸이 따로 있는데 내가 기억하는 건 스무 장 정도야.'],
      ['USER', '용지는 A4만 남아 있어.'],
      ['ASSISTANT', '스무 장 정도로 적어 둘게요.'],
    ],
    ev: [0, 2, 4], anchor: [2, '스무 장 정도'],
  },
  {
    sk: 'p1b6-sk-135ab77919a554dc', lang: 'KO', dp: 'SELF_REVISION',
    turns: [
      ['USER', '지난달에 배달을 네 번 시켰어.'],
      ['USER', '냉장고 제빙기가 좀 시끄러워졌어.'],
      ['USER', '아, 표현을 다시 할게. 가계부에 건당 금액이랑 월 합계를 같이 적어 두는데, 2만 원 언저리라는 숫자만 머리에 남았어.'],
      ['USER', '제빙기는 얼음 크기를 작게 바꿨어.'],
      ['USER', '카드 명세서를 정확히 본 건 아니고 감으로 말하는 거야.'],
      ['USER', '얼음이 빨리 어는 것 같기도 하고.'],
      ['ASSISTANT', '2만 원 언저리로 적어 둘게요.'],
    ],
    ev: [0, 2, 4, 6], anchor: [2, '2만 원 언저리'],
  },
  {
    sk: 'p1b6-sk-135ab77919a554dc', lang: 'KO', dp: 'CANONICAL',
    turns: [
      ['USER', '이번 주에 회의를 다섯 번 했어. 달력에는 회차별 소요 시간이랑 주간 누계가 같이 떠 있는데, 내 머리에 남은 건 대략 한 시간 반이야.'],
      ['USER', '회의실은 계속 3층을 썼고.'],
      ['ASSISTANT', '한 시간 반으로 적어 둘게요.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '고지서를 12월, 1월, 2월 세 장 받아 뒀고 거기엔 월 사용액이랑 겨울 누계가 같이 찍혀 있어.'],
    ],
  ...
  // --- p1b6-sk-38c426bb2e0bff42 | TRAIN/ESCALATE | a qualifier is mentioned but not attached ---
  {
    ...
    turns: [
      ['USER', '이번 sprint 회고는 금요일 오후로 잡았고, 같은 날 저녁에 release 점검도 있어.'],
      ['USER', '오늘 사내 카페 쿠폰이 만료됐어.'],
      ['USER', '격주로만 돌린다는 조건이 하나 붙었어.'],
    ],
    ev: [0, 2], anchor: [0, '금요일 오후로 잡았고'],
  },
  {
    sk: 'p1b6-sk-38c426bb2e0bff42', lang: 'KO', dp: 'PROGRESSIVE_REFINEMENT',
    turns: [
      ['USER', '다음 주 워크숍은 오전 10시에 시작하고, 오후에는 분과별 실습이 따로 있어.'],
      ['USER', '오늘 명함을 새로 받았어.'],
      ['USER', '더 붙이자면, 사전 등록자만 들어올 수 있다는 단서가 하나 있었어.'],
      ['USER', '명함은 로고가 바뀌었더라.'],
      ['ASSISTANT', '그대로 적어 둘게요.'],
    ],
    ev: [0, 2, 4], anchor: [0, '오전 10시에 시작하고'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '상호대차로 온 책은 2층 사무실에서 받고.'],
      ['USER', '버스는 배차가 10분이더라.'],
      ['USER', '다시 반납 얘기로 오면, 평일에만 받는다는 조건이 걸려 있어.'],
      ['USER', '다음엔 좀 일찍 나가야겠어.'],
  ...
  },
  {
    ...
    turns: [
      ['USER', 'The team lunch is booked for Thursday, and the client dinner is on the same week.'],
      ['USER', 'I finally replaced the desk lamp bulb.'],
      ['USER', 'Let me add: the budget only stretches to eight people.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ['USER', '이번 정기 점검은 토요일에 진행되고, 소방 점검은 그 주에 한 번 더 있어. 야간에만 들어갈 수 있다는 조건이 하나 붙어 있고.'],
    ],
    ev: [0], anchor: [0, '토요일에 진행되고'],
  },
  {
    ...
    turns: [
      ...
      ['USER', 'config 이관도 같은 밤에 붙어 있어. rollback window 안에서만 건드린다는 단서가 하나 있고.'],
      ['USER', '마이크는 케이블 문제였어.'],
  ...
  },
  {
    ...
    turns: [
      ['USER', '이번 분기 성과 면담은 팀장이 직접 진행하고, 커리어 면담은 인사팀이 따로 잡아.'],
      ['USER', '오늘 사무실 온도가 좀 낮았어.'],
      ['USER', '대면으로만 한다는 얘기가 돌더라.'],
    ],
    ev: [0, 2], anchor: [0, '팀장이 직접 진행하고'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 프린터 용지를 채웠어.'],
      ['USER', '대기자 전환도 같이 돌린대. 선결제한 사람만 해당된다는 단서가 하나 붙어 있고.'],
      ['USER', '용지는 두 박스 남았어.'],
      ['ASSISTANT', '선착순으로요?'],
      ['USER', '응, 그렇게 들었어.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '요즘 아침에 좀 쌀쌀해.'],
      ['USER', '절임 배추 수령은 형네가 맡기로 했고.'],
      ['USER', '이불을 겨울 것으로 바꿨어.'],
      ['USER', '오전에만 한다는 조건이 하나 붙어 있어.'],
      ['USER', '난방은 아직 안 켰어.'],
      ['ASSISTANT', '우리 집으로 적어 둘게요.'],
    ],
  ...
  },
  {
    sk: 'p1b6-sk-38c426bb2e0bff42', lang: 'KO', dp: 'PROGRESSIVE_REFINEMENT',
    turns: [
      ['USER', '이번 촬영은 실내에서 하고 소품 컷은 따로 잡았어. 더 말하자면 조명 대여가 되는 날만 가능하다는 단서가 하나 있어.'],
    ],
    ev: [0], anchor: [0, '실내에서 하고'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '2주차에는 과제 review가 따로 잡혀 있어. 정규직에게만 적용된다는 단서가 하나 있고.'],
      ['USER', '사진은 이번엔 잘 나왔어.'],
  ...
  },
  {
    ...
    turns: [
      ['USER', '이번 모임 회비는 1인당 3만 원이야. 아, 정확히 말하면 뒤풀이 비용은 그날 따로 걷어.'],
      ['USER', '오늘 우산을 새로 샀어.'],
      ['USER', '현금만 받는다는 말이 하나 붙어 있었어.'],
    ],
  ...
  // --- p1b6-sk-5229ea237196499d | TRAIN/ESCALATE | what the positive response targets ---
  {
    ...
    turns: [
      ['USER', '아까 회의에서 남은 예산을 회식에 쓰자는 제안이 먼저 나왔고, 바로 뒤에 그 돈으로 모니터를 바꾸자는 제안이 같이 올라왔어. 나는 좋다고 했고.'],
    ],
    ev: [0], anchor: [0, '회식에 쓰자는 제안'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '점심은 도시락을 시켰어.'],
      ['USER', '한 명은 인스턴스를 줄이자고 했고 다른 한 명은 아예 다른 리전으로 옮기자고 했어. 나는 괜찮다고 했어.'],
      ['USER', '도시락은 좀 짰어.'],
      ['ASSISTANT', '그렇게 적어 둘게요.'],
    ],
    ev: [0, 2, 4], anchor: [2, '인스턴스를 줄이자'],
  },
  {
    sk: 'p1b6-sk-5229ea237196499d', lang: 'KO', dp: 'ELLIPTICAL_REPLY',
    turns: [
      ['USER', '장보기 동선 얘기를 하다가 아내가 배송으로 바꾸자고 했고, 나는 주말에 몰아서 한 번만 가자고 했어.'],
      ['USER', '오늘 현관 센서등이 깜빡였어.'],
      ['ASSISTANT', '그래서 어떻게 됐어요?'],
      ['USER', '좋다고 했지.'],
    ],
    ev: [0, 2, 3], anchor: [0, '배송으로 바꾸자'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '동료가 CI에 coverage gate를 걸자고 했고, 옆자리는 gate 대신 주간 report만 돌리자고 했어.'],
      ['USER', '허리가 훨씬 편해졌어.'],
      ['USER', '나는 좋다고 답했어.'],
      ['USER', '모니터도 조금 내렸어.'],
      ['ASSISTANT', '그 내용 그대로요.'],
    ],
    ev: [0, 2, 4, 6], anchor: [2, 'coverage gate를 걸자'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 빨래를 돌렸어.'],
      ['USER', '더 말하자면, 친구는 실내 전시로 바꾸자고 했고 나는 날짜를 다음 주로 미루자고 했어. 그 두 얘기 끝에 그러자고 했어.'],
      ['USER', '빨래는 건조기에 돌렸어.'],
      ['ASSISTANT', '네, 그렇게 둘게요.'],
    ],
    ev: [0, 2, 4], anchor: [2, '실내 전시로 바꾸자'],
  },
  {
    sk: 'p1b6-sk-5229ea237196499d', lang: 'KO', dp: 'RETURN_TO_TOPIC',
    turns: [
      ['USER', '아까 하던 창고 정리 얘기로 돌아가면, 형이 다음 달에 한 번에 치우자고 했어.'],
      ['USER', '오늘 형광등을 갈았어.'],
      ['USER', '나는 주말마다 조금씩 빼자고 했어. 그 두 얘기 끝에 좋다고 했어.'],
    ],
    ev: [0, 2], anchor: [0, '다음 달에 한 번에 치우자'],
  },
  {
    sk: 'p1b6-sk-5229ea237196499d', lang: 'KO', dp: 'SELF_REVISION',
    turns: [
      ['USER', '동아리에서 회비 얘기가 길게 나왔어. 아, 정확히는 후배가 만 원 인상을 제안했고 회장은 인상 대신 행사를 줄이자고 했는데, 나는 찬성한다고 했어.'],
    ],
    ev: [0], anchor: [0, '만 원 인상'],
  },
  {
    ...
    turns: [
      ...
      ['USER', 'Someone proposed moving the reports to a weekly cadence, and someone else proposed dropping two sections instead. I said that sounded good.'],
      ['USER', 'The markers were all dried out.'],
      ['ASSISTANT', 'Noted.'],
    ],
    ev: [0, 2, 4], anchor: [2, 'moving the reports to a weekly cadence'],
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 사무실 창문을 닦았어.'],
      ['USER', '회의에서 build 시간이 길다는 얘기가 계속 나왔고, 누가 cache를 새로 깔자고 했는데 그 자리에서 build step을 아예 줄이자는 제안도 같이 나왔거든.'],
    ],
    ev: [0, 2], anchor: [2, 'cache를 새로 깔자'],
  },
  {
    sk: 'p1b6-sk-5229ea237196499d', lang: 'KO', dp: 'CONTEXT_FIRST',
    turns: [
      ...
      ['USER', '오늘 겨울옷을 꺼냈어.'],
      ['USER', '누나가 올해는 서울에서 모이자고 제안했어.'],
      ['USER', '패딩은 세탁소에 맡겼어.'],
      ['USER', '매형은 올해는 아예 건너뛰자고 했어. 나는 그 두 안을 놓고 좋겠다고 답했어.'],
      ['USER', '세탁은 사흘 걸린대.'],
      ['ASSISTANT', '그럼 그렇게 둘게요.'],
    ],
    ev: [0, 2, 4, 6], anchor: [2, '서울에서 모이자'],
  },
  {
    sk: 'p1b6-sk-5229ea237196499d', lang: 'KO', dp: 'ELLIPTICAL_REPLY',
    turns: [
      ...
      ['USER', '오늘 노트를 새로 샀어.'],
      ['USER', '한 분이 주 2회로 늘리자고 했고, 다른 분은 분량을 줄이자고 했어.'],
      ['USER', '노트는 줄 없는 걸로 골랐어.'],
      ['ASSISTANT', '그래서요?'],
      ['USER', '나는 좋다고 했어.'],
    ],
    ev: [0, 2, 4, 5], anchor: [2, '주 2회로 늘리자'],
  },
  {
    sk: 'p1b6-sk-5229ea237196499d', lang: 'KO', dp: 'INTERLEAVED',
    turns: [
      ['USER', '오늘 아침에 우산을 챙겼어.'],
      ['USER', '관리비가 계속 오른다는 얘기를 이웃들과 한참 했는데, 누가 관리사무소에 같이 항의하자고 했고 옆집은 명세서만 따로 받아 보자고 했어. 나도 좋다고 했어.'],
      ['USER', '비는 결국 안 왔어.'],
    ],
    ev: [1], anchor: [1, '같이 항의하자'],
  },
  ...
  // --- p1b6-sk-59c8f51891ab4996 | DEV/ESCALATE | simulation frame or real observation ---
  {
    ...
    turns: [
      ...
      ['USER', '오늘 사무실 의자를 바꿨어.'],
      ['USER', '아까 창구 두 개짜리 모의 상황을 돌려 봤고, 오후에는 실제로 창구를 두 개만 열고 손님을 받았거든.'],
      ['USER', '의자는 바퀴가 부드러워.'],
  ...
  },
  {
    ...
    turns: [
      ['USER', '아까 load test 시나리오를 하나 돌려 봤는데, 그 사이에 실제 traffic peak도 한 번 왔어. 응답이 800ms까지 올라갔어.'],
      ['ASSISTANT', '800ms요?'],
      ['USER', '응, 그 숫자.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ['USER', '아까 가계부 시뮬레이션을 한번 돌려 봤는데, 오늘 카드값도 마침 다 빠져나갔어.'],
      ['USER', '오늘 쌀을 주문했어.'],
  ...
  // --- p1b6-sk-a19bb9e94e9a416b | HELD/ESCALATE | rule after a category boundary change ---
  {
    ...
    turns: [
      ...
      ['USER', '오늘 운동복을 빨았어.'],
      ['USER', '지난달부터 정회원 기준을 가입 1년에서 6개월로 바꿨어. 나는 가입한 지 8개월이고 참가비 신청서는 기준 바뀌기 전에 내 뒀어.'],
      ['USER', '운동복은 두 벌 돌렸어.'],
      ['ASSISTANT', '신청서는 그 전에요?'],
      ['USER', '응, 바뀌기 전에.'],
    ],
    ev: [0, 2, 4, 5], anchor: [2, '가입한 지 8개월이고 참가비 신청서는 기준 바뀌기 전에 내 뒀어'],
  },
  {
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 노트북 받침대를 샀어.'],
      ['USER', '초안 단계 작업물은 개인 폴더에서 버전을 관리하기로 한 것도 있고.'],
      ['USER', '받침대는 알루미늄이야.'],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 외장 하드를 정리했어.'],
      ['USER', '용량 큰 영상은 주간 정리 때 외장 하드에 따로 보관하기로 한 것도 있고.'],
      ['USER', '하드에 공간이 꽤 남더라.'],
      ['USER', '내가 지금 다루는 건 그 큰 영상 파일이야.'],
      ['USER', '케이블도 같이 정리했어.'],
      ['ASSISTANT', '그 내용 그대로요.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', 'On class days the rack moves to the back room and everything goes there instead, and tomorrow is a class day.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 필통을 샀어.'],
      ['USER', '나도 상담 갔다 와서 선생님 친절한 건 인정했어. 삼십 분을 그냥 내주시더라.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 마우스를 바꿨어.'],
      ['USER', '아, 정확히 말하면 나도 써 보고 고개를 끄덕였어. 설정하느라 반나절을 썼거든.'],
      ['USER', '마우스는 무선으로 골랐어.'],
      ['ASSISTANT', '그대로 남겨 둘게요.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      ['USER', '오늘 사무실 의자를 옮겼어.'],
      ['USER', '나도 며칠 써 보고 API가 깔끔하다는 데는 동의했어.'],
      ['USER', '의자는 창가 쪽으로 뒀어.'],
      ['USER', 'signature 몇 개는 진짜 군더더기가 없더라.'],
      ['USER', '바퀴가 좀 뻑뻑해.'],
      ['USER', '그래서 그 부분은 나도 좋게 봤다고 말해 뒀어.'],
      ['USER', '기름칠을 해 볼까 싶어.'],
      ['ASSISTANT', '네, 그렇게 둘게요.'],
    ],
  ...
  },
  {
    ...
    turns: [
      ['USER', '결론만 말하면 나도 그 자리에서 고개를 끄덕였어. 선배가 그 동네는 조용하고 교통은 불편하다고 했거든. 나는 밤에 가 봤는데 확실히 조용하더라.'],
    ],
