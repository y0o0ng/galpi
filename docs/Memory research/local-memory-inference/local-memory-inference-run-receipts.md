...
> Status: **HISTORICAL EXECUTION / REVIEW RECEIPTS — NOT THE ACTIVE STUDY OR
> P1-B6 DESIGN AUTHORITY**
>
> The detailed phase history below was moved from the former root-level study
> document without changing its factual contents. Current contracts live in
> `local-memory-inference-study-design.md` and
> `local-memory-inference-p1b6-design.md`.
>
> Preserve the recorded outcome labels, hashes, commit IDs, measured counts,
> execution provenance, and caveats as historical evidence.
