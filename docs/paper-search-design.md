...
> 현재 상태 (2026-07-14): 1차 검색 Pi 인수 완료 (`a70d9d0`, mock 보강 `1d4c704`). S2 키 실검색·캐시·정규화 함정 케이스·Playwright 실제 카드 검증을 통과했으며 다음은 2차 논문 저장·중복 차단이다.
...
- [x] 정규화·캐시·429·timeout·입력 검증과 mock 함정 케이스 `node:test` 8개
