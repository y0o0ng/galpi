...
- [ ] Push가 전부 실패해도 Attention이 남고, 기기 둘의 성공·재시도가 각각 표현된다 — MAIL-3. `test/mail-push.test.js`가 fan-out 1회씩 · 한 기기 수락이 다른 기기를 종결하지 않음 · 410 구독만 만료 · lease 잃은 delivery 복귀를 값으로 잠갔다. **기기 2대 실물은 C11에서 확인하고 닫는다**
