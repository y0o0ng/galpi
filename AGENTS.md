...
- **ZERO에서 J126이 무너진다.** 총수익 +19.5%(J63) vs +4.7%(J126), 기대값 +0.040 vs **-0.841**로 순위가 둘 다 뒤집힌다. **원인은 폐지 건수가 아니라 포지션 크기다** — J126은 폐지가 6건(J63 9건)인데 ZERO 손실이 -$21,643(J63 -$11,109)으로 건당 3배다. 수량이 `R/2ATR`이라 긴 형성기간이 저변동 종목 쪽으로 기울면 같은 R에 달러 포지션이 커진다.
