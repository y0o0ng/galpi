...
- **P1-B6 신규 380-case dataset 계약은 CLOSED이고 skeleton candidate validator + blind HUMAN Pass-1 reviewer 첫 slice가 구현됐다.** real candidate/HUMAN review는 아직 없으며 다음은 actual skeleton authoring/generation contract다. 학습 실행·raw episode·private replay는 `UNOPENED`, production은 그대로이며 상세 정본은 위 canonical study다.
