...
function validateSkeletonCandidateFixture(fixture) {
  ...
  if (fixture.name !== CANDIDATE_FIXTURE_NAME || !Array.isArray(fixture.candidates)) {
    throw new TypeError('P1-B6 skeleton candidate fixture identity가 올바르지 않습니다.');
  }
  if (fixture.candidates.length < 2) {
    throw new TypeError('P1-B6 blind review fixture에는 최소 2개 candidate가 있어야 합니다.');
  }
