...
function buildPaperNoteContent({ paper, fileId, createdStr }) {
  ...
  if (paper.openAccessPdfUrl) frontmatter.push(`open_access_pdf_url: ${yamlString(paper.openAccessPdfUrl)}`);
  frontmatter.push(
  ...
  if (paper.openAccessPdfUrl) body.push('## 원문', `[공개 PDF 열기 ↗](${paper.openAccessPdfUrl})`);
