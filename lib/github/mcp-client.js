...
function validateRemoteTools(listed) {
  ...
  if (!names.includes(GITHUB_FILE_TOOL)) {
    throw clientError('GitHub Remote MCP에 get_file_contents 도구가 없습니다.', 'GITHUB_MCP_TOOL_MISSING');
  }
  if (tools.length !== 1 || names[0] !== GITHUB_FILE_TOOL) {
    throw clientError(
