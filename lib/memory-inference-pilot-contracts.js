...
function validateTaskResult(value, name = 'directResult') {
  ...
  if (value.schemaStatus === SCHEMA_STATUSES.INVALID && value.taskOutcome === TASK_OUTCOMES.SUCCESS) {
    throw new TypeError('invalid structured output은 direct-task success일 수 없습니다.');
  }
  return value;
}
