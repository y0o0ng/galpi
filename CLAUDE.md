...
- **P1-B6 1.7B ambiguity specialist supervised adaptation의 신규 380-case dataset 계약은 CLOSED다.** historical 60은 supervised corpus에서 제외된 diagnostic/regression 전용이고, 다음은 dataset/review-tool 구현 설계와 나머지 training 사전등록이다. 학습 실행·raw episode·private replay는 `UNOPENED`, production은 그대로이며 상세 정본은 위 canonical study다.
