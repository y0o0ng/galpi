...
EXPECTED_MEMBERS = {
    "SP500": ((None, 500, 6),),
    # **전환일은 2014-04-03이다.** 처음에 2014-12-22로 잡았는데, QQQ의 감사받은
    # 2014-09-30 보유가 103종목이라 그 전에 이미 다중 클래스가 있었다. 구글이 이중 클래스로
    # 갈라져 `GOOG`가 따로 상장한 날이 2014-04-03이고 그날부터 구성원이 100을 넘는다.
    "NDX100": ((None, 100, 1), ("2014-04-03", 104, 4)),
}
