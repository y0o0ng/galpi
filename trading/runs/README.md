...
|`qv-data-audit/`|—|데이터|**`quality-value` Phase 0.** PIT fundamentals를 과거 시점 기준으로 재현할 수 있는가|2026-09-16 자체 데이터 구축 종료 · `DATA_NOT_READY` 보류. 수익률 미계산. 종료 receipt는 해당 README §11|
