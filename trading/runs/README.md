...
|`qv-data-audit/`|—|데이터|**`quality-value` Phase 0.** PIT fundamentals를 과거 시점 기준으로 재현할 수 있는가|정찰 `SEC_ROUTE_VIABLE` — raw XBRL instance 경로 확인, companyfacts API 기각. ME shares 계약 확정. 본구현 미착수|
