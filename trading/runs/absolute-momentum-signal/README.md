...
**두 집계가 다른 것은 오류가 아니다.** 날짜마다 유효 관측 수가 다르기 때문이다 — 어떤
날짜는 TOP5 다섯 종목 중 넷만 +42 forward를 갖는다. 관측 가중은 그런 날짜에 가중치를 덜
주고 날짜 가중은 모든 날짜를 같게 본다. **결과를 본 뒤 둘 중 유리한 쪽을 고르지 않는다.**
