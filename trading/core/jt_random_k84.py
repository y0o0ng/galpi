"""`jt-random-k84` — 대조군. **`jt-k84`에서 랭킹만 무작위로 바꾼 것이다.**
...
from .jt_k84 import HOLD_SESSIONS

JT_RANDOM_K84 = CoreDefinition(
    name="jt-random-k84",
    policy=jt_policy(
        "research-jt-random-k84",
        "무작위 선택 대조군. K=84 만기 청산만, 낙폭 게이트 해제",
