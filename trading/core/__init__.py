...
|`jt-j126-k42-sma200-stop`|RS-only (J=126)|같은 control에서 **`exit_mode`만** 바꾼 2ATR 초기 손절 challenger|
...
from .jt_j126_k42_sma200_stop import JT_J126_K42_SMA200_STOP
